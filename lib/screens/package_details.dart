...
class PackageItems extends StatefulWidget {
  ...
  PackageItems({Key key, this.id}) : super(key: key);
...
class _PackageItemsState extends State<PackageItems> {
  ...
  Future<void> _onPressRemove(index) async {
    var item_id = _packagetems[index].id;
    _packagetems.removeAt(index);
    setState(() {});

    var packageDeleteResponse =
        await PackagesRepository().delete(item_id: item_id, value: 1);

    print("packageDeleteResponse${packageDeleteResponse.message}");

    ToastComponent.showDialog(packageDeleteResponse.message, context,
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        "${AppLocalizations.of(context).home_screen_packges_item} ${widget.id}",
  ...
  buildWishlist() {
    ...
    } else if (_packagetems.length > 0) {
      return SingleChildScrollView(
        child: ListView.builder(
          itemCount: _packagetems.length,
      ...
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return ProductDetails(
            id: _packagetems[index].product.id,
          );
        }));
      },
      child: Stack(
                    ...
                    Container(
                        ...
                        child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              ...
                              image: _packagetems[index].product.thumbnailImg ??
                                  'https://via.placeholder.com/600x400',
                              fit: BoxFit.cover,
                            ))),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              _packagetems[index].product.name,
                          ...
                          Padding(
                            ...
                            child: Text(
                              "${_packagetems[index].product.unitPrice}",
