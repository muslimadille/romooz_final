...
class MapLocationUpdate extends StatefulWidget {
  MapLocationUpdate({Key key, this.address}) : super(key: key);
  var address;

  @override
  State<MapLocationUpdate> createState() => MapLocationUpdateState();
}

class MapLocationUpdateState extends State<MapLocationUpdate>
